    ...
    <section className="flex h-full grow flex-col items-center justify-center px-4">
      ...
      <section>
        <header className="flex flex-col items-center justify-center">
          <h1 className="font-poppins bg-gradient-to-b from-blue-600 to-blue-900 bg-clip-text pb-2 text-center text-4xl font-bold text-transparent sm:text-5xl">
            Fastest Fingers First
          </h1>
          <h2 className="font-open text-center text-sm font-medium text-zinc-700 sm:text-lg">
